...
function divider(numbersArray) {
  ...
  var organizedArray = [evensArray, oddsArray]
...
function finder(array) {
  var arbitraryNumber = getRandomArbitrary()
  for (var i = 0; i < array.length; i++) {
    if (array[i] === arbitraryNumber)  {
      return true;
    }
  }
  return false
...
devMountainEmployees.splice(0,0,tyler, cahlan, ryan, colt);//Code Here
...
users.splice(0,0,user1, user2, user3)//Code Here
